...
public class CardService extends HostApduService {
    ...
    // AID for our loyalty card service.
     private static final String SAMPLE_LOYALTY_CARD_AID = "0123456789";
    //private static final String SAMPLE_LOYALTY_CARD_AID = "F0394148148100";
    ...
    public byte[] processCommandApdu(byte[] commandApdu, Bundle extras) {
        ...
        if (Arrays.equals(SELECT_APDU, commandApdu)) {
            ...
            Log.i(TAG, "Transaction Succesful!");
            //saveAccount = account;

            temp = ConcatArrays(accountBytes, SELECT_OK_SW);
        }
        else {
            Log.i(TAG, "Error in transaction!");
            temp = UNKNOWN_CMD_SW;
